  ...
  return (
    <div className='lesson-container'>
      <div className="header-container">
        ...
        <button className={cx('circle', { 'is-active': isExpanded })} onClick={toggleAccordionItem}><svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg" >
