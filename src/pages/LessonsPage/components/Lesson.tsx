  ...
  return (
    ...
    <div className='lesson-container'>
      <div className="header-container">
        ...
        {/* <div className="circle" ><ArrowSvgSelector id='down'/></div> */}
        <button className='circle'><svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content-container">
        <div className="video-container grid">
          ...
          <a className="video-link container-470" href={ lesson.videoLink }>Ссылка</a>
